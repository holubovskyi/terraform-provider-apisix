...
local:
	...
	mv ${BINARY}_${VERSION}_darwin_amd64 ~/.terraform.d/plugins/${HOSTNAME}/${NAMESPACE}/${NAME}/${VERSION}/darwin_amd64/${BINARY}
	mv ${BINARY}_${VERSION}_linux_amd64 ~/.terraform.d/plugins/${HOSTNAME}/${NAMESPACE}/${NAME}/${VERSION}/linux_amd64/${BINARY}
